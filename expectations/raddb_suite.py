...
threshold_date = current_date - timedelta(hours=threshold)
safe_add_expectation(
    suite,
...
safe_add_expectation(
    ...
    meta={"check_id": "raddb:range:acctinterval"},
    column="acctinterval",
    min_value=0,
    max_value=86580
)
...
safe_add_expectation(
    suite,
    gx.expectations.ExpectColumnValuesToBeNonNull,
...
safe_add_expectation(
    suite,
    gx.expectations.ExpectColumnValuesToBeGreaterThan,
    meta={"check_id": "raddb:order:acctstoptime"},
    column="acctstoptime",
    min_value=gx.expectations.ExpectColumnValuesToBeGreaterThan(
